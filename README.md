...
|---|---|---|
| 1 | `01_utrecht_boundary_extraction.ipynb` | Extracts Utrecht province and city boundaries from Dutch administrative GML data |
| 2 | `02_permian_formation_screening.ipynb` | Screens ThermoGIS Permian formations for Utrecht spatial coverage |
| 3 | `03_well_log_preprocessing.ipynb` | Loads LAS files, imputes missing well log values, prepares final dataset |
| 4 | `04_utrecht_geothermal_simulation.ipynb` | Runs ThermoGIS geothermal doublet simulation clipped to Utrecht |
